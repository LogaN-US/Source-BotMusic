...
class music(commands.Cog):
    ...
    @commands.command(name="h",alisases=['ajuda'],help="Comando de ajuda")
    ...
    @commands.command(name="p", help="Toca uma música do YouTube",aliases=['play','tocar'])
    ...
    @commands.command(name="f", help="Mostra as atuais músicas da fila.",aliases=['q','fila'])
    ...
    @commands.command(name="s", help="Pula a atual música que está tocando.",aliases=['pular'])
